...
class _SideDrawerState extends State<SideDrawer> with TickerProviderStateMixin {
  ...
  Widget createMenuItems(DrawerMenuController menuController) {
  ...
  Widget createDrawer(DrawerMenuController menuController) {
    List<Widget> widgets = [];
    ...
    DrawerMenuController controller = DrawerScaffold.currentController(context);
    return Transform(
  ...
  Widget build(BuildContext context) {
    ...
    return DrawerScaffoldMenuController(
        direction: widget.direction,
        builder: (BuildContext context, DrawerMenuController menuController) {
