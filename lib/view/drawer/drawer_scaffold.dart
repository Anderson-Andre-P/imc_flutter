...
typedef Widget DrawerScaffoldBuilder(
    BuildContext context, DrawerMenuController menuController);
...
class DrawerScaffold extends StatefulWidget {
  ...
  static DrawerMenuController currentController(BuildContext context,
      {bool nullOk = true}) {
...
class _DrawerScaffoldState<T> extends State<DrawerScaffold>
  ...
  List<DrawerMenuController>? menuControllers;
  ...
  DrawerMenuController createController(SideDrawer d) {
    DrawerMenuController controller = dcreateController(
      context,
      d,
      this,
      (value) {
  ...
  DrawerMenuController dcreateController(BuildContext context, SideDrawer d,
      TickerProvider vsync, Function(double) onAnimated) {
    DrawerMenuController controller = DrawerMenuController(
      d,
      onAnimated,
      context: context,
      vsync: vsync,
    ...
    Widget content = !widget.enableGestures!
        ...
        : GestureDetector(
            ...
            onHorizontalDragUpdate: (details) {
              ...
              DrawerMenuController menuController =
  ...
  zoomAndSlideContent(Widget content) {
    ...
    DrawerMenuController menuController =
        this.menuControllers![focusDrawerIndex];
  ...
  DrawerMenuController get _controller => menuControllers![focusDrawerIndex];
}
...
class DrawerScaffoldMenuControllerState
  ...
  DrawerMenuController getMenuController(BuildContext context,
...
class DrawerMenuController extends ChangeNotifier {
  ...
  DrawerMenuController(this._drawer, this.onAnimated,
...
class DrawerScaffoldController {
  List<DrawerMenuController>? _menuControllers;
